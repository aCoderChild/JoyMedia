(() => {
  ...
  frappe.form.formatters = {
    ...
    Percent: function(value, docfield, options) {
      ...
      const valuePrecision = ((_a = value == null ? void 0 : value.toString().split(".")[1]) == null ? void 0 : _a.length) || 0;
    ...
    make_list_row(result = {}) {
      ...
      this.get_datatable_columns().forEach(function(column) {
        ...
        contents += `<div class="list-item__content ellipsis">
				${head ? `<span class="ellipsis text-muted" title="${column_label}">${column_label}</span>` : column !== "name" ? `<span class="ellipsis result-row" title="${value}">${value}</span>` : `<a href="${id_href}" class="list-id ellipsis" title="${value}">
							${value}</a>`}
			</div>`;
      });
...
//# sourceMappingURL=dialog.bundle.R2DXA74W.js.map
