(() => {
        ...
        make_page() {
          ...
          if (!this.opts || !this.opts.do_not_make_page) {
            ...
            $(".main-section").on("scroll.treeview_" + this.page_name, () => {
              if (frappe.get_route_str() === me2.page_name) {
                me2.scroll_position = $(".main-section").scrollTop();
              }
            });
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/listing.html
...
`;
  ...
  frappe.ui.filter_utils = {
    ...
    get_default_condition(df) {
      ...
      if (["_assign", "_liked_by"].includes(df.fieldname)) {
        return "like";
      } else if (df.fieldtype == "Data" && !(meta == null ? void 0 : meta.is_large_table)) {
        return "like";
      ...
      $.each(me2.table_fields, function(i2, table_df) {
        if (table_df.options && !table_df.is_virtual) {
          ...
          $.each(frappe.utils.sort(child_table_fields, "label", "string"), function(i3, df) {
            let doctype = frappe.get_meta(me2.doctype).istable && me2.parent_doctype ? me2.parent_doctype : me2.doctype;
            if (frappe.perm.has_perm(doctype, df.permlevel, "read"))
              me2.add_field_option(df, table_df);
          });
        }
      });
    }
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/filters/edit_filter.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/html/print_template.html
...
`;
  ...
  frappe.views.BaseList = class BaseList {
    ...
    setup_resize_handler() {
      $(window).off("resize.list-view").on(
        "resize.list-view",
        frappe.utils.debounce(() => {
          var _a3;
          if ((_a3 = cur_list == null ? void 0 : cur_list.$result) == null ? void 0 : _a3.is(":visible")) {
  ...
  var FilterArea = class {
    ...
    set_standard_filter(filters) {
      ...
      return filters.reduce((out, filter) => {
        ...
        const is_unchecked_check = ((_b = (_a3 = fields_dict[fieldname]) == null ? void 0 : _a3.df) == null ? void 0 : _b.fieldtype) === "Check" && !cint(value);
        if (fields_dict[fieldname] && !is_unchecked_check && (condition === "=" || condition === "like" && ((_d = (_c = fields_dict[fieldname]) == null ? void 0 : _c.df) == null ? void 0 : _d.fieldtype) != "Link" || condition === "descendants of (inclusive)" && ((_f = (_e = fields_dict[fieldname]) == null ? void 0 : _e.df) == null ? void 0 : _f.fieldtype) == "Link")) {
    ...
    async make_standard_filters() {
      ...
      fields.map((df) => {
        ...
        if (input_fieldtypes.includes(df.fieldtype)) {
          const saved_conditions = frappe.get_user_settings(this.list_view.doctype, this.list_view.view_name).filter_conditions || {};
    ...
    filter_field_with_match_type(df) {
      setTimeout(() => {
        ...
        $dropdown.find(".dropdown-item").on("click", (e) => {
          ...
          const saved_conditions = frappe.get_user_settings(this.list_view.doctype, this.list_view.view_name).filter_conditions || {};
          (_b = (_a3 = this.list_view).save_view_user_settings) == null ? void 0 : _b.call(_a3, {
            filter_conditions: __spreadProps(__spreadValues({}, saved_conditions), { [df.fieldname]: new_type })
          });
          let value = (_c = field.get_value) == null ? void 0 : _c.call(field);
          if (new_type === "=" && value) {
  ...
  var ListSettings = class {
    ...
    make() {
      ...
      me2.dialog = new frappe.ui.Dialog({
        title: me2.doctype === "List View Settings" ? __("List View Settings") : __("{0} List View Settings", [__(me2.doctype)]),
  ...
  frappe.views.ListView = class ListView extends frappe.views.BaseList {
    ...
    get_header_html() {
      ...
      let $columns = this.columns.map((col) => {
        ...
        const fieldname_attr = ((_d = col.df) == null ? void 0 : _d.fieldname) ? `data-fieldname="${col.df.fieldname}"` : "";
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar_stat.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_view_permission_restrictions.html
...
`;
  ...
  frappe.views.FileView = class FileView extends frappe.views.ListView {
    ...
    get_breadcrumbs_html() {
      ...
      return folders.map((folder, i2) => {
        ...
        return `<a href="${frappe.utils.escape_html(route2)}">${title}</a>`;
      }).join("&nbsp;/&nbsp;");
    }
    get_header_html() {
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/image_view_item_row.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/photoswipe_dom.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_board.html
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_column.html
  frappe.templates["kanban_column"] = `<div class="kanban-column" data-column-value="{{title}}" style="background-color: var(--kanban-column-bg);">
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_card.html
...
//# sourceMappingURL=list.bundle.QIVVOXYJ.js.map
