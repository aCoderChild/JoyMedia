(() => {
  ...
  $(document).ready(function() {
    ...
    if (site_info) {
      ...
      const banner_message = isFCUser ? `Please upgrade for uninterrupted services. Take help from our ${partners_link} to get started.` : "Please contact your system administrator to upgrade your plan.";
      let card_args = {
  ...
  function getFrappePartnersUrl() {
    var _a;
    const country = (_a = frappe.boot.sysdefaults) == null ? void 0 : _a.country;
    return country ? `https://frappe.io/partners/list?country=${encodeURIComponent(country)}` : "https://frappe.io/partners/regions";
  }
...
//# sourceMappingURL=billing.bundle.DBDNFU32.js.map
