(() => {
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/address_list.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/contact_list.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_dashboard.html
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_footer.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_links.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/form_sidebar.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/print_layout.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/report_links.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/set_sharing.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/timeline_message_box.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/form/templates/users_in_sidebar.html
...
`;
  ...
  frappe.ui.form.Toolbar = class Toolbar {
    ...
    can_submit() {
      return frappe.model.is_submittable(this.frm.doc.doctype) && this.get_docstatus() === 0 && !this.frm.doc.__islocal && !this.frm.doc.__unsaved && this.frm.perm[0].submit && !this.has_workflow();
    }
    can_update() {
        ...
        function() {
          ...
          frappe.workflow.get_transitions(me.frm.doc).then((transitions) => {
            const next_actions = $.map(
              transitions,
              (d2) => `${frappe.utils.bold(d2.action)} ${__("by Role")} ${d2.allowed}`
            ).join(", ") || __("None: End of Workflow").bold();
            const document_editable_by = frappe.workflow.get_document_state_roles(me.frm.doctype, state).map((role) => frappe.utils.bold(role)).join(", ");
            $(d.body).html(
              `
  ...
  frappe.ui.form.Share = class Share {
    ...
    render_shared(shared) {
      ...
      $(
        frappe.render_template("set_sharing", {
          ...
          shared: this.shared,
          everyone,
          custom_perm_types: ((_a = frappe.boot.doctype_ptype_map) == null ? void 0 : _a[this.frm.doctype]) || []
        })
      ).appendTo(d.body);
    ...
    add_share_button() {
      ...
      $(d.body).find(".btn-add-share").on("click", function() {
        ...
        var custom_perm_types = ((_a = frappe.boot.doctype_ptype_map) == null ? void 0 : _a[me.frm.doctype]) || [];
...
//# sourceMappingURL=form.bundle.PBXIH5XX.js.map
