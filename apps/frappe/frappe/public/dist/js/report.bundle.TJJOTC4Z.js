(() => {
    ...
    setup_defaults() {
      ...
      if (this.report_name) {
        return this.get_report_doc().then((doc) => {
          ...
          this.selected_page_count = this.page_length = this.report_doc.json.page_length || 20;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_grid.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_tree.html
...
`;
  ...
  // frappe-html:/workspace/development/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/group_by/group_by.html
...
//# sourceMappingURL=report.bundle.TJJOTC4Z.js.map
